...
public class reg1 extends BaseTest {
	...
	public void checking_the_registration_New_account_KSA_Store1() throws Exception {
	...
	public void checking_the_registration_New_account_KSA_Store5() throws Exception {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		HomePage homePage = new HomePage();
		goToPage(homePage);
		waitUntilClickable(homePage.getSwitchLangLink());
